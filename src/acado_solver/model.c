...
const double d_dot = in[38]-Vsafe*t6;
...
out[9] = -t9*(alpha*1.64663711873934E-1+in[7]*1.58960374141736E-1+in[9]*4.10704191099466E-2-in[15]*1.58960374141736E-1-8.48173994434413E-4);
...
else if (e_t_ne>-in[42]) {
    e_t_1_ne = sin((3.141592653589793*e_t_ne*(1.0/2.0))/in[42]);
}
else {
    e_t_1_ne = -1.0;
}
...
if (e_t_d>in[40]) {
    ...
    e_t_1_d = sin((3.141592653589793*e_t_d*(1.0/2.0))/in[40]);
}
else {
    e_t_1_d = -1.0;
}
...
else if (fabs(norm_v)<in[43]) {
    vbar_n=((sin(2*norm_v/in[43]/3.141592653589793)-1)+1)*n_dot;
    vbar_e=((sin(2*norm_v/in[43]/3.141592653589793)-1)+1)*e_dot;
    vbar_d=((sin(2*norm_v/in[43]/3.141592653589793)-1)+1)*d_dot;
}
else {
    vbar_n=n_dot/norm_v;
    vbar_e=e_dot/norm_v;
...
const double t6 = e_t_ne+in[42];
const double t7 = in[41]*t6;
const double t8 = exp(t7);
const double t9 = t8+1.0;
const double t10 = 1.0/t9;
const double t11 = e_t_ne-in[42];
const double t15 = in[41]*t11;
...
const double t18 = e_t_d+in[40];
const double t19 = in[39]*t18;
const double t20 = exp(t19);
const double t21 = t20+1.0;
const double t22 = 1.0/t21;
const double t23 = e_t_d-in[40];
const double t24 = exp(-in[39]*t23);
const double t25 = t24+1.0;
const double t26 = 1.0/t25;

// soft constraints
double a_soft;
if (alpha>(in[44]-in[46])) {
    a_soft=(t3*t3)*t4;
}
else if (alpha>(in[45]+in[46])) {
    a_soft=0.0;
}
else {
    a_soft=t4*(t5*t5);
...
out[0] = e_t_1_ne;
out[1] = e_t_1_d;
out[2] = -vbar_n-Td_n*t16+Tpd_n*t17;
out[3] = -vbar_e-Td_e*t16+Tpd_e*t17;
out[4] = -vbar_d-Td_d*(t22+t26-1.0)+Tpd_d*(t22+t26);
out[5] = Vsafe;
out[6] = in[8];
out[7] = in[9];
out[8] = in[10];
...
const double t3 = alpha-in[41]+in[43];
const double t4 = 1.0/(in[43]*in[43]);
const double t5 = -alpha+in[42]+in[43];
...
else if (e_t_ne>-in[39]) {
    e_t_1_ne = sin((3.141592653589793*e_t_ne*(1.0/2.0))/in[39]);
}
else {
    e_t_1_ne = -1.0;
}
...
if (e_t_d>in[37]) {
    ...
    e_t_1_d = sin((3.141592653589793*e_t_d*(1.0/2.0))/in[37]);
}
else {
    e_t_1_d = -1.0;
}
...
else if (fabs(norm_v)<in[40]) {
    vbar_n=((sin(2*norm_v/in[40]/3.141592653589793)-1)+1)*n_dot;
    vbar_e=((sin(2*norm_v/in[40]/3.141592653589793)-1)+1)*e_dot;
    vbar_d=((sin(2*norm_v/in[40]/3.141592653589793)-1)+1)*d_dot;
}
else {
    vbar_n=n_dot/norm_v;
    vbar_e=e_dot/norm_v;
...
const double t6 = e_t_ne+in[39];
const double t7 = in[38]*t6;
const double t8 = exp(t7);
const double t9 = t8+1.0;
const double t10 = 1.0/t9;
const double t11 = e_t_ne-in[39];
const double t15 = in[38]*t11;
const double t12 = exp(-t15);
const double t13 = t12+1.0;
const double t14 = 1.0/t13;
const double t16 = t10+t14-1.0;
const double t17 = t10+t14;
const double t18 = e_t_d+in[37];
const double t19 = in[36]*t18;
const double t20 = exp(t19);
const double t21 = t20+1.0;
const double t22 = 1.0/t21;
const double t23 = e_t_d-in[37];
const double t24 = exp(-in[36]*t23);
const double t25 = t24+1.0;
const double t26 = 1.0/t25;
