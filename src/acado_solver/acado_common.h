...
/** Matrix of size: 8 x 9 (row major format) */
real_t rk_diffsNew2[ 72 ];

/** Row vector of size: 104 */
real_t state[ 104 ];
...
/** Matrix of size: 30 x 8 (row major format) */
real_t R2[ 240 ];
...
/** Matrix of size: 60 x 30 (row major format) */
real_t A[ 1800 ];
