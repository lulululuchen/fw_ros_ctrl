...
class PWQG {
    ...
    public:
        ...
        void setFPAAppMax(const double fpa) { fpa_app_max_ = fpa; };

        // gets
        double getFPAAppMax() { return fpa_app_max_; }

        // public functions
        double evaluate(double &err_lon, const double d_ref, const double unit_path_tangent_d, const double veh_pos_d,
